  ...
  <div class="wrapper">
    ...
    <nav id="sidebar">
      ...
      <div class="card bg-light mb-3" style="max-width: 18rem;margin: 5px 5px 5px 5px">
        ...
        <div class="card-body">
          <form action="filter-result.php" target="iframe_a" method="POST">
    ...
    <div id="content">
      <nav class="navbar navbar-light bg-light justify-content-between">
        ...
        <a href="http://dvform.com/viewRCI.php" ><i aria-hidden="true" class="fa fa-list-ul"></i> View All RCI</a>
      ...
      <br>
      <p><iframe align="center" height="460px" id="iframe_a" name="iframe_a" src="display_all_rci.php" style=" margin-top: -10px; margin-bottom: -10px;" width="100%"></iframe>
      </p>
